...
# gemini-3.5-flash: GA since May 2026, not deprecated.
...
# gemini-2.5-pro: stable GA model, still fully supported (only the Flash /
# Flash-Lite tier of the 2.5 generation is being retired early).
